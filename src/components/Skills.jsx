  ...
  return (
    <section id="skills" className="skills-section">
      ...
      <div className="skills-grid">
        ...
        <div className="skill-item">
          <img src="./angular-icon.svg" alt="angular" className="skill_icons" />
          <div className="skill-name">Angular</div>
        </div>
        <div className="skill-item">
          <img src="./NodeJs.svg" alt="Node.js" className="skill_icons" />
          <div className="skill-name">NodeJS</div>
        </div>
        
        <div className="skill-item">
          <img src="./python.svg" alt="python" className="skill_icons" />
          <div className="skill-name">Python</div>
        </div>
        <div className="skill-item">
          <img src="./darkgreen.svg" alt="MongoDB" className="skill_icons" />
          <div className="skill-name">MongoDB</div>
        </div>
        <div className="skill-item">
          <img src="./sky.svg" alt="PostgreSQL" className="skill_icons" />
          <div className="skill-name">PostgreSQL</div>
        </div>
        <div className="skill-item">
          <img src="./versal.svg" alt="Vercel" className="skill_icons" />
        ...
        <div className="skill-item">
          <img src="./github.svg" alt="Git" className="skill_icons" />
        ...
        <div className="skill-item">
          <img src="./aws.svg" alt="AWS" className="skill_icons" />
        ...
        <div className="skill-item">
          <img src="./javascript.svg" alt="JavaScript" className="skill_icons" />
          <div className="skill-name">JavaScript</div>
        </div>
        {/* New skills below */}
        <div className="skill-item">
          <img src="./blue.svg" alt="Prisma" className="skill_icons" />
          <div className="skill-name">Prisma</div>
        </div>
        <div className="skill-item">
          <img src="./bun.svg" alt="Bun" className="skill_icons" />
          <div className="skill-name">Bun</div>
        </div>
        <div className="skill-item">
          <img src="./clerk.svg" alt="Clerk" className="skill_icons" />
        ...
        <div className="skill-item">
          <img src="./gray.svg" alt="Expo" className="skill_icons" />
        ...
        <div className="skill-item">
          <img src="./claude-icon.svg" alt="Cloud" className="skill_icons" />
          <div className="skill-name">Claude</div>
        </div>
     
        <div className="skill-item">
          <img src="./vs.svg" alt="VS Code" className="skill_icons" />
